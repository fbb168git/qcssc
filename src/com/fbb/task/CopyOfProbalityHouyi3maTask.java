...
public class CopyOfProbalityHouyi3maTask {
	public void start() {
		houyi3ma();
	}
	...
	public void houyi3ma() {
		...
		ArrayList<Lottery> lotterys = lotteryDao.getByStartDate("2017-01-01", "2017-03-31");
		...
		System.out.println("1no2yes:" + successList2.size() + " 占比："
				+ (100f * (successList2.size()) / (float)count2)
				+ "%");
		System.out.println("12no3yes:" + successList3.size() + " 占比："
				+ (100f * (successList3.size()) / (float)count3)
				+ "%");
	}
